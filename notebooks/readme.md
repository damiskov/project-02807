...
- The dataset is READ ONLY. Everything you do must be relative to the raw dataset located in `data/raw_dataset.csv`. If you perform a bunch of transformations and don't want to redo these, simply save you transformed dataset locally and ADD IT TO THE GITIGNORE.
